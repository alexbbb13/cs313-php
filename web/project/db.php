...
function insertUser($db, $username, $login, $password) {
	...
	$stmt = $db->prepare('INSERT INTO users (username, login, password, status, created_at) VALUES (:username,:login,:password,
	...
	$stmt->bindParam(':active', 'Active', PDO::PARAM_STR, 80);
	$stmt->execute();
